...
import coursePng from "../../images/python.png";

let data = {
  topic: "Python-разработчик",
  description:
    "Курс по Python-разработке предназначен для тех, кто хочет овладеть одним из самых востребованных языков программирования в мире. Python применяется в веб-разработке, анализе данных, машинном обучении,  автоматизации и многих других областях. Участники курса познакомятся с основами языка, изучат продвинутые  темы и научатся применять Python для решения реальных задач.",
  img: coursePng,
  program: {
